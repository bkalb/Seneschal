...
INSERT INTO "new_RandomTable" ("campaignId", "category", "createdAt", "diceExpression", "id", "isStateful", "lastResult", "name", "rollOnDayAdvance", "sortOrder", "updatedAt") SELECT "campaignId", "category", "createdAt", "diceExpression", "id", "isStateful", "lastResult", "name", "rollOnDayAdvance", "sortOrder", "updatedAt" FROM "RandomTable";
